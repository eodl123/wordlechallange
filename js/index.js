...
const displayGameover = () =>{
    ...
    div.style = "display:flex; justify-content:center; align-items:center; position:absolute; top:40vh; left:40vw; background-color:red; width:200px; height:50px;";
 ...
 const handleBackspace = () => {
    ...
    const handleKeydown = (event) => { 
        ...
        if(event.key==='Backspace') handleBackspace();
            ...
            if (event.key === "Enter")handelEnterKey();
            else return;
